;; library.scm - Library functions and macros integral to Scheme
;; Copyright (C) 2009  Tom Elam
;; Copyright (C) 2006  Chris Double
;; Copyright (C) 2003  Alex Yakovlev
;; 
;; This file is part of jsScheme 0.1-tae.
;; 
...
;; http://www.tomelam.com or, normally, by clicking the 'Download
;; jsScheme' button wherever jsScheme 0.1-tae is installed on a web
;; server.  To obtain the source code via mail order, send your
;; request to Tom Elam at the email address 'tomelam@gmail.com'.
